...
> **Status: source-acquisition + initial drafting phase.** Public-domain Greek
...
> (`ch01.txt` … `ch16.txt`) plus `chapter_map.json`. The first actual
> chapter draft now exists at
