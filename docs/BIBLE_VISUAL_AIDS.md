...
Waves 3–6 now ship as catalog v6 (**209 unique assets, 296 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v6) | absolute set + curated Waves 2–6 | 296 | 1.0% | a teaching layer across 53 books |
| **Wave A — next broad step** | `--min-score 6 --per-chapter-cap 2 --exclude-ids <published>` | ~709 new (+296 shipped) | 3.2% | roughly one aid every chapter or two |
...
Catalog v6's teaching-first Waves 4–6 are now live. The refreshed map remains an
editorial queue, not an auto-generation list; it lives at
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v6-live-20260816/`
beside the Codex publish staging tree, with
`published_anchor_ids-v6.json` one level up. Review every row against the
