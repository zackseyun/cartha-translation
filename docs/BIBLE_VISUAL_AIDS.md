...
Waves 3–43 now ship as catalog v36 (**356 unique assets, 600 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v36) | absolute set + curated Waves 2–43 | 600 | 1.9% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~220 new (+600 shipped) | 2.6% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v36-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v36.json` and the cumulative
