...
Waves 3–44 now ship as catalog v37 (**359 unique assets, 603 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v37) | absolute set + curated Waves 2–44 | 603 | 1.9% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~188 new (+603 shipped) | 2.5% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v37-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v37.json` and the cumulative
