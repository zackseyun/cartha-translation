...
Waves 3–24 now ship as catalog v14 (**290 unique assets, 405 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v14) | absolute set + curated Waves 2–24 | 405 | 1.3% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~521 new (+405 shipped) | 3.1% | roughly one aid every chapter or two |
...
Catalog v14's teaching-first Wave 24 is now live. The refreshed map remains an
editorial queue, not an auto-generation list; it lives at
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v14-reviewed-r2-20260817/`
beside the Codex publish staging tree, with
`published_anchor_ids-v14.json` and the cumulative
