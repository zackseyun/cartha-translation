...
Waves 3–42 now ship as catalog v35 (**356 unique assets, 590 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v35) | absolute set + curated Waves 2–42 | 590 | 1.9% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~260 new (+590 shipped) | 2.7% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v35-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v35.json` and the cumulative
