...
Waves 3–39 now ship as catalog v32 (**344 unique assets, 535 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v32) | absolute set + curated Waves 2–39 | 535 | 1.7% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~358 new (+535 shipped) | 2.9% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v32-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v32.json` and the cumulative
