...
Waves 3–38 now ship as catalog v31 (**336 unique assets, 496 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v31) | absolute set + curated Waves 2–38 | 496 | 1.6% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~396 new (+496 shipped) | 2.9% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v31-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v31.json` and the cumulative
