...
Waves 3–31 now ship as catalog v23 (**301 unique assets, 419 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v23) | absolute set + curated Waves 2–31 | 419 | 1.3% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~504 new (+419 shipped) | 3.1% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v23-reviewed-r2/`
beside the Codex publish staging tree, with
`published_anchor_ids-v23.json` and the cumulative
