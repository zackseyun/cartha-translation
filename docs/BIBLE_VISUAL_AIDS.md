...
Waves 3–35 now ship as catalog v28 (**314 unique assets, 441 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v28) | absolute set + curated Waves 2–35 | 441 | 1.4% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~479 new (+441 shipped) | 3.0% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v28-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v28.json` and the cumulative
