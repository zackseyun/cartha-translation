...
Waves 3–45 now ship as catalog v38 (**361 unique assets, 614 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v38) | absolute set + curated Waves 2–45 | 614 | 2.0% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~147 new (+614 shipped) | 2.4% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v38-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v38.json` and the cumulative
