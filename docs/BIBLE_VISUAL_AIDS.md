...
Waves 3–30 now ship as catalog v21 (**300 unique assets, 417 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v21) | absolute set + curated Waves 2–30 | 417 | 1.3% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~509 new (+415 shipped) | 3.1% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v20-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v20.json` and the cumulative
