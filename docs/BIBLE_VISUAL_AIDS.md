...
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~508 new (+417 shipped) | 3.1% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v21-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v21.json` and the cumulative
