...
Waves 3–46 now ship as catalog v39 (**362 unique assets, 619 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v39) | absolute set + curated Waves 2–46 | 619 | 2.0% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~89 new (+619 shipped) | 2.3% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v39-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v39.json` and the cumulative
