...
Waves 3–34 now ship as catalog v27 (**309 unique assets, 433 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v27) | absolute set + curated Waves 2–34 | 433 | 1.4% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~486 new (+433 shipped) | 3.0% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v27-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v27.json` and the cumulative
