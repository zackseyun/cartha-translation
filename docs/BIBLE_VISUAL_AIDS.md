...
Waves 3–37 now ship as catalog v30 (**328 unique assets, 476 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v30) | absolute set + curated Waves 2–37 | 476 | 1.5% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~425 new (+476 shipped) | 2.9% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v30-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v30.json` and the cumulative
