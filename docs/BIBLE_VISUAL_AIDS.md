...
Waves 3–28 now ship as catalog v18 (**298 unique assets, 414 placements across
...
| --- | --- | --- | --- | --- |
| Shipped (v18) | absolute set + curated Waves 2–28 | 414 | 1.3% | a teaching layer across 53 books |
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~515 new (+414 shipped) | 3.1% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v18-reviewed/`
beside the Codex publish staging tree, with
`published_anchor_ids-v18.json` and the cumulative
