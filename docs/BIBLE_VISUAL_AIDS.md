...
| **Wave A — next broad step** | published exclusions + editorial dispositions | ~506 new (+419 shipped) | 3.1% | roughly one aid every chapter or two |
...
`~/Documents/New project/output/bible-visual-aid-map/wave-a-v23-reviewed/`
