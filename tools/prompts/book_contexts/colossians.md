# Colossians — book context for review

- **Source**: Nestle-Aland 28 / SBL Greek NT. 4 chapters.
- **Form**: Pauline letter (deutero-Pauline for many scholars). Theology (1–2) then ethics (3–4). Responds to a "Colossian philosophy" involving angelic veneration and ascetic practice.
- **Date**: ca. 60 AD (if Pauline) or ca. 70–90 AD (if pseudonymous).
- **Original audience**: The church at Colossae in the Lycus Valley.

## Key translation issues

1. **The Christ Hymn** (1:15–20): Formatted as poetry. Key terms:
   - **εἰκὼν τοῦ θεοῦ τοῦ ἀοράτου** (1:15 — "image of the invisible God"): Keep "image" — not "reflection" or "representation."
...
- Dense theological prose with hymnic sections.
- The Christ Hymn (1:15–20) is elevated poetry — format accordingly.
- Ethical sections (3:1–4:6) are direct imperatives.

## Known pitfalls

- **Rendering πρωτότοκος as "first-created"** — it means "firstborn" (primacy of inheritance/status, not necessarily temporal first).
- **Resolving the στοιχεῖα debate** in the translation.
