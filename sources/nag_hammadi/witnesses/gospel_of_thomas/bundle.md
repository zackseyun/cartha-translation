# Gospel of Thomas witness bundle
...
- **poxy654_greek** — fetched (greek_overlap_witness)
- **poxy1_greek** — fetched (greek_overlap_witness)
- **poxy655_greek** — fetched (greek_overlap_witness)
