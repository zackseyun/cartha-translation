...
independent textual corroboration before any reading can affect POB.
...
5. keep blinded Codex passes separate until reconciliation;
6. classify each result as machine-observed, machine-corroborated,
   machine-hypothesis, or lost; and
7. keep novel uncorroborated readings out of the main translation.
